  ...
  bake: {
    ...
    bakingMethod: {
      ...
      methods: {
        "dutch-oven": {
          title: "סיר ברזל יצוק",
          description: "הסטנדרט. סיר עם מכסה, 24-28 ס״מ.",
        },
        "stone-with-steam": {
          title: "אבן/פלדת אפייה + תבנית אדים",
          description: "אבן או פלדה לוהטת, מים רותחים בתבנית נפרדת לאדים.",
        },
        "tray-with-bowl": {
          title: "תבנית + קערה הפוכה",
          description: "תבנית רגילה + קערת מתכת/קרמיקה הפוכה (לא זכוכית רגילה, לא פלסטיק).",
        },
      },
      trayBowlSafetyWarning:
